...
The spread operator is a versatile tool that simplifies common operations and helps keep your code 
clean and readable by avoiding unnecessary loops or concatenations.
*/
...
//5.Object Properties:In objects, you can use the spread operator to clone an object or merge properties into a new object (available in ES9 and later).
const obj1 = { name: "Alice", age: 30 };
const obj2 = { ...obj1, city: "New York" }; // Creates a new object { name: "Alice", age: 30, city: "New York" }

//6.Function Rest Parameters:Inside a function, you can use the spread operator to collect multiple arguments into an array.
