...
/*3.Lexical this Binding:Arrow functions do not have their own this context; 
instead, they inherit the this value from the surrounding (lexical) context. 
This can be very helpful in certain scenarios, especially when dealing with callback functions or methods within objects.
*/
...
/*4.No Arguments Object:Arrow functions also do not have their own arguments object like traditional functions. 
Instead, they inherit the arguments object from the enclosing function if needed.
*/
function sum() {
    const add = () => {
